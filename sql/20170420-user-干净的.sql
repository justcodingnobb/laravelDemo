...
insert  into `li_admins`(`id`,`section_id`,`name`,`realname`,`email`,`password`,`remember_token`,`phone`,`lasttime`,`lastip`,`status`,`created_at`,`updated_at`) values (1,1,'admin','adminss','fsda@eee.com','$2y$10$biXU7qCre8VPP8yUfNY91.gVzbX7ExCzDP7J.T5MtAhCQQj1cf4EK','21Nc3o7tjqGgrgeASJrskIkxYfUimiUJcOTnlGWKqAPoyW8LPC4XIAx1f124','13123212345','2017-04-20 16:51:58','127.0.0.1',1,'2016-08-07 10:05:54','2017-04-20 16:51:58'),(2,1,'market','dddd','fsda@qq.com','$2y$10$UCK/ej.B8PjZ5rwcLtyyb.T.1MQj6cv2GeeBa6MgUd5PbXDiyOcoy','DYIZEeUGarGtADYvjxBzQuLCTfuvtpV83HuZ12oJAE1BMKqV7qSKZrlZm8Xz','','2016-12-15 09:46:33','192.168.1.162',1,'2016-12-15 09:46:33','2016-12-15 10:10:01');
...
insert  into `li_logs`(`id`,`admin_id`,`user`,`url`,`created_at`) values (1,1,'admin','/admin/admin/mypwd','2017-04-20 16:51:58'),(2,1,'admin','/admin/group/add','2017-04-20 16:56:40'),(3,1,'admin','/admin/group/add','2017-04-20 16:56:51'),(4,1,'admin','/admin/group/edit/1','2017-04-20 16:56:55'),(5,1,'admin','/admin/group/edit/1','2017-04-20 16:57:00'),(6,1,'admin','/admin/user/status/1/0','2017-04-20 17:29:32'),(7,1,'admin','/admin/user/status/1/1','2017-04-20 17:29:34');
...
insert  into `li_migrations`(`id`,`migration`,`batch`) values (1,'2017_03_09_103612_create_users_table',1),(2,'2017_03_09_103714_create_groups_table',1);
