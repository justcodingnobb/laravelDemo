...
insert  into `li_articles`(`id`,`catid`,`title`,`thumb`,`describe`,`content`,`source`,`url`,`status`,`listorder`,`created_at`,`updated_at`) values (1,1,'设备2-1','','','<p>&nbsp; &nbsp; &nbsp;sss &nbsp; &nbsp;fsdad &nbsp; &nbsp;</p>','','',0,4,'2016-08-07 10:36:48','2016-12-02 10:14:42'),(2,1,'fsa','','','<p>&nbsp; &nbsp; &nbsp; &nbsp;fsfdfdfdfddadfd &nbsp; &nbsp;</p>','','',0,2,'2016-08-07 10:44:08','2016-12-02 10:14:54');
