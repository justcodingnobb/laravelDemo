...
<body class="box">
    <div class="mainbox">
        ...
        <section class="right overh">
            <iframe name="right" id="rightMain" src="{{ url('/xycmf/index/main') }}" frameborder="false" scrolling="auto" style="border:none; margin-bottom:30px" width="100%" height="auto" allowtransparency="true"></iframe>
        </section>
    ...
    <script>
        $(function(){
            // 加载默认左侧菜单
            $("#subnav").load('/xycmf/index/left/1');
            // 点击切换左侧菜单列表
            $("#mainmenu li a").click(function(){
                var mid = $(this).attr('data-menuid');
                $("#subnav").load("/xycmf/index/left/"+mid);
